                ...
                data.length
                    ...
                    <div className="after:absolute after:top-0 after:h-2  after:w-full after:content-[''] after:right-0 after:bg-gradient-to-t after:from-transparent after:to-white dark:after:to-gray-900  before:absolute before:bottom-0 before:h-2  before:w-full before:content-[''] before:left-0 before:bg-gradient-to-b before:from-transparent before:to-white dark:before:to-gray-900 relative ">
                        <div className="max-h-[50vh]  overflow-y-auto px-5">
                            ...
                            >
                                {data.map((item, index) => (
                                    <div key={index} className="p-2 my-3 rounded-md w-full  bg-gray-100 dark:bg-gray-800" >
                                        <div className="flex-col w-full">
                                            <div className="flex justify-between">
                                                <div className="flex items-center pr-2 text-md">
                                                    {
                                                        <div className="!w-full  ">
                                                            <input
                                                                ...
                                                                className=" !bg-transparent !rounded-none focus:!outline-none !border-none  focus:!bg-transparent text-md p-0 w-full"
                                                                key={index + "text"}
                                                                value={item.data} />
                                                        </div>
                                                    }
                                                ...
                                                <div className="flex" >
                                                    ...
                                                    <button type="button" className="text-white select-none size-8 flex justify-center items-center bg-gradient-to-r ml-3 from-blue-500 via-blue-600 hover:cursor-grab handle active:cursor-grabbing  to-blue-700 hover:bg-gradient-to-br  font-medium rounded-lg  text-center">
                    ...
                    :
                    <div className=" text-center my-10 text-xl text-gray-950 dark:text-white ">هیچ موردی وجود ندارد</div>
            }
        </>
